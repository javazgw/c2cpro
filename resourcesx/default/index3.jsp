										...
										<div class="spacial-product-wrap">
											<div class="spacial-product-carousel owl-carousel">
												...
												<div class="single-product-item">
													...
													<figure class="product-thumb">
														<a href="single-product.html"><img src="assets/img/product-5.jpg" alt="Product"></a>
													</figure>
												...
												<div class="single-product-item">
													...
													<figure class="product-thumb">
														<a href="single-product.html"><img src="assets/img/product-2.jpg" alt="Product"></a>
													</figure>
								...
								<div class="product-content-wrap">
									...
									<nav class="product-teb-menu">
										<ul class="nav justify-content-center" role="tablist">
											<li>
												<a class="active" href="#new-products" id="new-product-tab" data-toggle="tab">New Products
												</a>
											</li>
											<li>
												<a href="#sale-products" id="sale-product-tab" data-toggle="tab">OnSale</a>
											</li>
											<li>
												<a href="#feature-products" id="feature-product-tab" data-toggle="tab">Feature Products
												</a>
											</li>
										</ul>
									</nav>
										...
										<div class="tab-pane fade show active" id="new-products" role="tabpanel">
											<div class="products-wrapper">
												<div class="product-carousel-home3 owl-carousel">
													...
													<div class="single-product-item">
														<figure class="product-thumb">
															<a href="single-product.html"><img src="assets/img/product-3.jpg" alt="Product"></a>
															<a href="#" class="btn btn-round btn-cart" title="Quick View" data-toggle="modal" data-target="#quickView"><i class="fa fa-eye"></i></a>
														</figure>
														<div class="product-details">
															<h2 class="product-title"><a href="single-product.html">Voyage Yoga
													...
													<div class="single-product-item">
														<figure class="product-thumb">
															<a href="single-product.html"><img src="assets/img/product-4.jpg" alt="Product"></a>
															<a href="#" class="btn btn-round btn-cart" title="Quick View" data-toggle="modal" data-target="#quickView"><i class="fa fa-eye"></i></a>
														</figure>
														<div class="product-details">
										...
										<div class="product-content-wrap">
											...
											<nav class="latest-pro-tab-menu">
												<ul class="nav justify-content-center justify-content-lg-end" role="tablist">
													<li>
														<a class="active" href="#computer-products" id="computer-products-tab" data-toggle="tab">Computer</a>
													</li>
													<li>
														<a href="#smartphone-products" id="smartphone-products-tab" data-toggle="tab">Smart Phone
														</a>
													</li>
													<li>
														<a href="#camera-products" id="camera-products-tab" data-toggle="tab">Camera</a>
													</li>
												</ul>
											</nav>
											<!-- Product Tab Menu End -->
