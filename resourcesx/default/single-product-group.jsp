								...
								<div class="col-lg-7">
									<div class="product-details">
												...
												<table class="table table-bordered">
													<tbody>
														<tr>
															...
															<td class="pro-title">
																<a href="single-product.jsp">CROWN SUMMIT BACKPACK</a>
															</td>
														...
														<tr>
															<td class="product-quantity">
																<div class="quantity-field">
																	...
																	<input type="number" id="qty_2" min="1" max="100" value="2">
																</div>
															</td>
															<td class="pro-title">
																<a href="single-product.jsp">Vestibulum suscipit</a>
															</td>
															<td class="pro-price"><span>$125.00</span></td>
														</tr>
													</tbody>
												</table>
											</div>
										...
										<div class="product-quantity mt-15">
											<a href="#" target="_blank" class="btn btn-cart-large"><i class="fa fa-shopping-bag"></i> Buy Now</a>
										</div>
									</div>
								</div>
								<!-- Product Details End -->
