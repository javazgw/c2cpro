							...
							<div class="row">
								...
								<div class="col-lg-7">
									<div class="product-details">
										...
										<p class="products-desc">Ideal for cold-weathered training worked lorem ipsum outdoors, the Chaz Hoodie promises superior warmth with every wear. Thick material blocks out the wind as ribbed cuffs and bottom band seal in body heat Lorem ipsum dolor sit amet, consectetur adipisicing elit. Enim, eal for cold-weathered training worked lorem ipsum outdoors, the Chaz Hoodie promises superior warmth with every wear. Thick material blocks out reprehenderit. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis exercitationem explicabo fuga ipsum magni nam, quasi quisquam sunt vel voluptate.</p>

										<a href="#" target="_blank" class="btn btn-cart-large"><i class="fa fa-shopping-cart"></i> Buy Now</a>
									</div>
								</div>
							</div>
							<!-- Product Details End -->
